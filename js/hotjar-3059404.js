window.hjSiteSettings = window.hjSiteSettings || {
  site_id: 3059404,
  rec_value: 9.999999994736442e-10,
  ...
  legal_name: "Lambda",
  privacy_policy_url: "https://www.lambdalabs.com/legal",
...
!(function () {
    ...
    b = {
      ...
      start: function () {
        try {
          ...
          console.debug("Error in metrics.start", { error: t });
        }
      },
      reset: function () {
        u.loggedMetrics = {};
      ...
      timeIncr: function (t, e) {
        ...
        return (
          l(t, m.tagName, { total: w }),
          c && b.timeEnd(t, { tag: o, total: w, extraTags: f, type: h }),
          w
        );
      },
  ...
  (window.hjBootstrap =
    ...
    (window.hjLazyModules = window.hjLazyModules || {
      SURVEY_V2: { js: "survey-v2.0c43bbc168fe6cf63cc8.js" },
      SURVEY_BOOTSTRAPPER: {
        js: "survey-bootstrapper.e068d4da5877f107712a.js",
      },
      SURVEY_ISOLATED: { js: "survey-isolated.40fe79479a0f13258431.js" },
      HEATMAP_RETAKER: { js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js" },
      SURVEY_INVITATION: { js: "survey-invitation.20158c9248b11ff9848d.js" },
      NOTIFICATION: { js: "notification.7536b7a2a6bf5125e2b4.js" },
